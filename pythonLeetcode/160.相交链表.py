...
#         self.next = None
    ...
    #     first = headA if countA>=countB else headB
    #     second = headA if countA<countB else headB
        
    #     fast = countA-countB if countA>= countB else countB-countA
        
    #     while fast and first:
    #         first = first.next
    #         fast -= 1
